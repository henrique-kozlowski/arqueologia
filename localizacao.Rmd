...
sitios_tabela <- read.csv2("tabelas/sitios.csv", encoding = "UTF-8")
sitios_tabela <- sitios_tabela %>% rename(nome = X.U.FEFF.sitio)
```
...
```{r echo=FALSE}
sitios_tabela %>%
  datatable(colnames = c("Sítio", "Categoria", "Município", "X", "Y", "Código CNSA", "Referência"),
